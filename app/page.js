...
const MODELS = {
  'gpt-oss-120b': { label: 'gpt-oss-120b', energyPer1kTokens: 2.8, speed: 45 },
  'gpt-oss-20b': { label: 'gpt-oss-20b', energyPer1kTokens: 0.9, speed: 80 },
  'qwen2.5-72b-instruct': { label: 'Qwen2.5-72B-Instruct', energyPer1kTokens: 2.5, speed: 50 },
  'qwen2.5-7b-instruct': { label: 'Qwen2.5-7B-Instruct', energyPer1kTokens: 0.7, speed: 90 },
  'llama-3.1-70b-instruct': { label: 'Llama 3.1 70B Instruct', energyPer1kTokens: 3.2, speed: 35 },
  'llama-3.2-3b-instruct': { label: 'Llama 3.2 3B Instruct', energyPer1kTokens: 0.5, speed: 95 },
  'mistral-nemo-12b': { label: 'Mistral NeMo 12B', energyPer1kTokens: 0.4, speed: 100 },
};
...
const MODEL_TOKEN_SCALE = {
  ...
  'mistral-nemo-12b': 0.45,
};

// Vary output per model — every model has a variant for every step
const MODEL_OUTPUT_VARIANTS = {
  'parse': {
    'gpt-oss-120b': '{"intent": "comprehensive_stock_research", "ticker": "TSLA", "analysis_type": "buy_sell_recommendation", "scope": "fundamental_technical_sentiment", "timeframe": "current_with_outlook"}',
    'gpt-oss-20b': '{"intent": "stock_analysis", "ticker": "TSLA", "action": "buy_sell", "scope": "standard"}',
    'qwen2.5-72b-instruct': '{"intent": "stock_research_and_recommendation", "ticker": "TSLA", "analysis_type": "buy_sell", "scope": "comprehensive", "include": ["fundamentals", "technicals", "sentiment"]}',
    'qwen2.5-7b-instruct': '{"intent": "stock_analysis", "ticker": "TSLA", "action": "buy_sell_recommendation", "timeframe": "current"}',
    'llama-3.1-70b-instruct': '{"intent": "stock_analysis", "ticker": "TSLA", "type": "buy_sell_recommendation", "depth": "full"}',
    'llama-3.2-3b-instruct': '{"intent": "stock_analysis", "entity": "TSLA", "task": "buy_or_sell"}',
    'mistral-nemo-12b': '{"ticker": "TSLA", "action": "recommend"}',
  },
  'research': {
    'gpt-oss-120b': 'Tesla (TSLA) is currently trading at $248.42, representing a 2.3% decline in today\'s session. The company reported Q4 2024 revenue of $25.7B, beating consensus estimates of $25.3B. The analyst community remains divided with 18 buy ratings, 12 hold ratings, and 7 sell ratings. Key risk factors include intensifying competition from Chinese EV manufacturers (BYD, NIO, XPeng) which are gaining global market share, and ongoing margin pressure from Tesla\'s aggressive price reduction strategy. On the positive side, FSD v13 is showing promising real-world results with intervention rates dropping 40%, energy storage deployments surged 150% year-over-year reaching 14.7 GWh, and Optimus humanoid robot development continues ahead of internal timelines. The forward P/E ratio of 62x remains significantly elevated compared to the automotive industry average of 15x and even the broader tech sector average of 28x.',
    'gpt-oss-20b': 'TSLA at $248.42 (-2.3%). Q4 revenue $25.7B beat estimates. Analysts: 18 buy, 12 hold, 7 sell. Risks: Chinese EV competition, margin pressure. Catalysts: FSD v13, energy storage +150% YoY, Optimus progress. P/E 62x vs industry 15x.',
    'qwen2.5-72b-instruct': 'TSLA trades at $248.42 (-2.3%). Revenue of $25.7B beat estimates. The street is split: 18 buys vs 7 sells. Main headwind is Chinese EV competition squeezing margins. Tailwinds include FSD v13 rollout and energy storage surging 150% YoY. Valuation at 62x earnings is steep against sector avg of 15x.',
    'qwen2.5-7b-instruct': 'TSLA $248.42 (-2.3%). Q4 beat at $25.7B rev. Mixed consensus. China competition + margin risk vs FSD + energy tailwinds. P/E 62x elevated.',
    'llama-3.1-70b-instruct': 'Tesla stock: $248.42, down 2.3% intraday. Earnings: $25.7B revenue (beat). Consensus: mixed with 18 buy, 12 hold, 7 sell. Analysts worry about margin compression from price wars. Bullish case: FSD, energy, Optimus. Bearish case: valuation, competition. Short interest low at 3.2%.',
    'llama-3.2-3b-instruct': 'TSLA at $248. Earnings were good. Analysts are split. Competition from China is a concern. FSD and energy storage are positives.',
    'mistral-nemo-12b': 'TSLA $248.42. Revenue beat. Mixed analyst views. China risk. FSD positive.',
  },
  'sentiment': {
    'gpt-oss-120b': 'Comprehensive sentiment analysis across multiple data sources yields an aggregate score of MIXED-POSITIVE at 0.62/1.0. Breaking this down by channel: Financial news sentiment registers as Neutral (0.48) — earnings met expectations but didn\'t significantly surprise. Social media sentiment is Bullish (0.78) driven primarily by retail investor excitement around FSD v13 demo videos and Optimus updates. Institutional sentiment reads Cautious (0.41) with primary concerns around stretched valuation multiples and sector rotation risk. Short interest has declined to 3.2% of float, down from 4.1% three months ago, suggesting bearish conviction is fading. Options flow shows elevated call buying at $270-$300 strikes for 3-month expiry.',
    'gpt-oss-20b': 'Sentiment: MIXED-POSITIVE (0.62). News: neutral (earnings met, not exceeded). Social: bullish (FSD excitement). Institutional: cautious (valuation). Short interest: 3.2% and declining.',
    'qwen2.5-72b-instruct': 'Overall sentiment aggregate: MIXED-POSITIVE (0.62/1.0). News sentiment neutral — earnings met but didn\'t exceed expectations. Social channels bullish, driven by FSD v13 demos. Institutional positioning cautious on valuation. Short interest at 3.2%, trending down from 4.1% last quarter. Options market showing elevated call activity at $270+ strikes.',
    'qwen2.5-7b-instruct': 'Sentiment: MIXED-POSITIVE (0.6). News: neutral. Social: bullish. Institutions: cautious. Short interest declining.',
    'llama-3.1-70b-instruct': 'Sentiment score: 0.62 (mixed-positive). News neutral, social bullish on FSD, institutional cautious. Short interest 3.2% declining. Overall constructive but not uniformly positive.',
    'llama-3.2-3b-instruct': 'Positive sentiment overall. Social media bullish on FSD. News neutral. Shorts decreasing.',
    'mistral-nemo-12b': 'Sentiment: 0.58 positive. Mixed signals across sources.',
  },
  'technical': {
    'gpt-oss-120b': 'The technical picture for TSLA is constructive across multiple timeframes. RSI(14) at 54 indicates neither overbought nor oversold conditions. MACD generated a bullish crossover 3 sessions ago with increasing histogram momentum. Price maintains position above both the 50-day MA ($235) and 200-day MA ($218), confirming the intermediate uptrend. Key support at $230 (prior resistance turned support). Primary resistance at $265 (recent swing high). Volume profile shows declining volume on the current 3-day pullback, which is constructive — suggests selling pressure is exhausting. A bull flag pattern is forming on the daily chart with a measured move target of $280-290. Fibonacci retracement of the last leg up shows current price testing the 38.2% level, a common bounce point in uptrends.',
    'gpt-oss-20b': 'RSI 54 (neutral), MACD bullish crossover, price above both 50-day ($235) and 200-day ($218) MAs. Support at $230, resistance at $265. Bull flag pattern forming. Volume declining on pullback — constructive.',
    'qwen2.5-72b-instruct': 'Technical setup is favorable. RSI neutral at 54, MACD crossed bullish recently. Trading above key moving averages (50d: $235, 200d: $218). Support at $230, resistance at $265. Bull flag on daily chart targets $280-290. Volume declining on pullback is a positive sign.',
    'qwen2.5-7b-instruct': 'RSI 54 neutral. MACD bullish. Above 50d/200d MA. Support $230, resistance $265. Bull flag forming.',
    'llama-3.1-70b-instruct': 'RSI: 54 (neutral zone). MACD: bullish crossover 3 days ago. Price above 50-day MA ($235) and 200-day MA ($218). Support: $230. Resistance: $265. Volume declining on pullback (constructive). Daily chart: bull flag pattern, target $280-290.',
    'llama-3.2-3b-instruct': 'RSI 54. MACD bullish. Above moving averages. Support $230, resistance $265. Looks okay technically.',
    'mistral-nemo-12b': 'RSI: 54. MACD: bullish. Above 50MA and 200MA. Support $230. Resistance $265.',
  },
  'synthesize': {
    'gpt-oss-120b': 'Recommendation: BUY with conviction score of 7.5/10. The investment thesis rests on a confluence of bullish technicals (MACD crossover, price above key MAs, bull flag formation), improving sentiment (declining short interest, bullish options flow), and strong fundamental catalysts (FSD v13 showing 40% improvement in intervention rates, energy storage at inflection point with 150% YoY growth). Suggested entry zone: $245-250 on the current pullback. Price target: $290 over a 3-6 month horizon based on bull flag measured move and peer multiple expansion. Stop loss: $220 (below 200-day MA, invalidates the technical thesis). Recommended position size: 3-5% of portfolio given elevated single-stock risk. Key risk: if broader market corrects, TSLA\'s high beta (~1.8) will amplify downside significantly.',
    'gpt-oss-20b': 'BUY — conviction 7/10. Entry $245-250, target $290, stop $220. Technicals and sentiment supportive. Key catalysts: FSD, energy storage. Risk: high beta in market correction. Size: 3-5% of portfolio.',
    'qwen2.5-72b-instruct': 'BUY with moderate conviction (7/10). Entry: $245-250 range. Target: $290 (3-6 month). Stop loss: $220. Thesis: Strong fundamentals with FSD and energy catalysts justify premium valuation near-term. Risk/reward favorable at current pullback from highs. Position size: 3-5% of portfolio. Key risk: If broader market corrects, high-beta TSLA will amplify losses.',
    'qwen2.5-7b-instruct': 'BUY (6/10 conviction). Entry: ~$248. Target: $280. Stop: $225. Catalysts outweigh risks near-term but valuation is stretched.',
    'llama-3.1-70b-instruct': 'BUY — conviction 6.5/10. Fundamentals solid, technicals constructive, sentiment net positive. Entry $245-250, target $285, stop $220. Moderate position size recommended given elevated P/E.',
    'llama-3.2-3b-instruct': 'Buy TSLA around $248. Target $275. Stop $225. Decent setup but valuation is high.',
    'mistral-nemo-12b': 'BUY. Entry $248. Target $270. Stop $225.',
  },
};
